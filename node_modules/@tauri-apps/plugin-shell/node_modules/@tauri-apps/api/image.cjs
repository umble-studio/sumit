...
class Image extends core.Resource {
    ...
    static async fromPngBytes(bytes) {
        return core.invoke('plugin:image|from_png_bytes', {
            bytes: transformImage(bytes)
        }).then((rid) => new Image(rid));
    }
    /**
     ...
     * ```
     */
    static async fromIcoBytes(bytes) {
        return core.invoke('plugin:image|from_ico_bytes', {
            bytes: transformImage(bytes)
        }).then((rid) => new Image(rid));
    }
    /**
    ...
    async width() {
        return core.invoke('plugin:image|width', { rid: this.rid });
    }
    /** Returns the height of this image. */
    async height() {
        return core.invoke('plugin:image|height', { rid: this.rid });
    }
}
/**
